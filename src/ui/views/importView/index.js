...
class ImportView {
    ...
    async processLCXData(lcxData) {
        ...
        progress.show([
            { title: 'Инициализация', description: 'Подготовка базы данных и парсера' },
            { title: 'Парсинг файла', description: 'Чтение и валидация LCX данных' },
            { title: 'Загрузка категорий', description: 'Сохранение категорий деталей' },
            { title: 'Загрузка цветов', description: 'Сохранение информации о цветах' },
            { title: 'Загрузка деталей', description: 'Сохранение каталога деталей' },
            { title: 'Загрузка связей', description: 'Сохранение связей деталь-цвет' },
            { title: 'Завершение', description: 'Обновление индексов и финализация' }
        ], {
            onCancel: () => {
